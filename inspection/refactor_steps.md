...
Sections 11–16 (portfolio holdings/metrics, market sorting, admin visibility,
account flows, UI/empty states, and deployment) have moved to
`inspection/refactor_steps_part2.md` to keep this file manageable.
